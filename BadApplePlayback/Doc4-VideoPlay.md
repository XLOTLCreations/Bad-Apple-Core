...
* Type in or copy paste 'python send\_bin.py COM12 badapple\_12x9\_30fps\_8bit.bin' in the terminal, change the 'COM12' to whatever COM port your board enumerates to, wait for the computer terminal to display a successful message and terminate.
